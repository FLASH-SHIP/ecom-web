...
export declare const setPassword: import("@trpc/server").TRPCMutationProcedure<{
    input: {
        id: string;
        password: string;
    };
...
export declare const auditHistory: import("@trpc/server").TRPCQueryProcedure<{
    input: {
        id: string;
    };
    output: {
...
export declare const verificationCodesList: import("@trpc/server").TRPCQueryProcedure<{
    input: {
        search?: string | undefined;
        page?: number | undefined;
        perPage?: number | undefined;
...
//# sourceMappingURL=customers.handler.d.ts.map