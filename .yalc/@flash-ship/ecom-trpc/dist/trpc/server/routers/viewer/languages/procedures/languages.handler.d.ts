...
export declare const getActive: import("@trpc/server").TRPCQueryProcedure<{
    input: void;
    output: import("@ecom/features/language/services/LanguageLocaleCache").CachedLanguage[];
    meta: object;
}>;
export declare const getById: import("@trpc/server").TRPCQueryProcedure<{
    input: {
        id: number;
    };
    output: {
...
export declare const getDefault: import("@trpc/server").TRPCQueryProcedure<{
    input: void;
    output: import("@ecom/features/language/services/LanguageLocaleCache").CachedLanguage;
    meta: object;
}>;
...
export declare const setDefault: import("@trpc/server").TRPCMutationProcedure<{
    input: {
        id: number;
    };
    output: {
...
export declare const getRelatedItems: import("@trpc/server").TRPCQueryProcedure<{
    input: {
        referenceId: number;
...
export declare const saveContentLanguage: import("@trpc/server").TRPCMutationProcedure<{
    input: {
        referenceId: number;
        referenceType: string;
        langCode: string;
...
export declare const worldLanguages: import("@trpc/server").TRPCQueryProcedure<{
    input: void;
    output: readonly [{
...
//# sourceMappingURL=languages.handler.d.ts.map