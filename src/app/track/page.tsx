...
import { Search, Package, MapPin, Calendar, Check, Copy, CheckCircle2, Plane, ChevronDown, ArrowRight } from "lucide-react";
      ...
      <section className="w-full bg-white relative z-20">
        <div className="custom-container relative lg:border-x lg:border-[#dadada] bg-white !pl-4 !pr-4 md:!pl-[60px] md:!pr-[60px] pt-[60px] pb-16 flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-8 w-full relative z-10">
            ...
            <form onSubmit={handleTrack} className="flex w-full max-w-[676px] h-[56px] items-center">
              ...
              <div className="flex-1 border border-[#dadada] flex flex-col bg-white overflow-hidden">
                ...
                <div className="bg-[#EBFAEF] border-b border-[#dadada] px-4 md:px-[60px] py-[24px] flex flex-col gap-2">
                  <div className="flex items-center justify-between w-full gap-4">
                    ...
                    <div className="flex items-center gap-2 text-[14px]">
                      <span className="text-[#232323] font-mono font-medium">{trackingNumber || "1ZB86780DA01972838"}</span>
                      <button 
                ...
                <div className="px-4 md:px-[60px] py-[32px] flex-grow flex flex-col">
                  <div className="text-[24px] md:text-[32px] font-medium leading-snug text-[#232323] mb-6">
                    Wednesday, June 17 <span className="text-[18px] md:text-[24px] text-[#7A7A7A] font-normal">Handed to Receiver at</span> 10:36 A.M.
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-8 sm:gap-24 mt-6">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[15px] font-semibold text-[#232323]">SANTA FE SPRINGS, CA US</span>
                    </div>
                    <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-5 justify-center h-full">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[14px] text-[#7A7A7A] mt-0.5">SANTA FE SPRINGS, CA US</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 border-t border-[#dadada]/40 pt-4 items-start">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[14px] text-[#7A7A7A] mt-0.5">UPS Worldwide Express Saver®</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 border-t border-[#dadada]/40 pt-4 items-start">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[15px] font-semibold text-[#232323]">Shipment Category</span>
                  ...
                  <div className="flex gap-4 border-t border-[#dadada]/40 pt-4 items-start">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[15px] font-semibold text-[#232323]">Shipped / Billed On</span>
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 md:gap-12 items-start border-t border-slate-100 pt-8">
                    ...
                    <div className="flex-grow flex flex-col gap-1 text-[15px]">
                      <h4 className="font-semibold text-[#232323] text-[16px]">We Have Your Package</h4>
