      ...
      icon: (className: string) => (
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M5 17h2m10 0h2m-4 0H9m-4-1v-5h10v6m4-5v5m0-5h-4v-5H5v5"
          />
        </svg>
      ),
    },
      ...
      icon: (className: string) => (
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 7.5V17m-6-4.5A6 6 0 0012 19a6 6 0 006-6M6 12.5h2m8 0h2"
          />
        </svg>
      ),
    },
      ...
      icon: (className: string) => (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 002 2h2a2.5 2.5 0 002.5-2.5V8a2 2 0 00-2-2h-1a2 2 0 00-2-2v-.065M12 20a8 8 0 100-16 8 8 0 000 16z"
          />
        </svg>
      ),
    },
            ...
            {firstBlockFeatures.map((feature, idx) => (
              ...
              >
                <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#C9FFF9] group-hover:bg-[#0F798C] transition-all duration-300 shrink-0">
                  {feature.icon(
                    "w-6 h-6 text-[#0F798C] group-hover:text-white transition-all duration-300",
                  )}
                </div>
              ...
              >
                ...
                <div className="flex flex-col p-6 flex-grow justify-between">
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[14px] text-[#7A7A7A] leading-relaxed">{card.desc}</p>
                  </div>
