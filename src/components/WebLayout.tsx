              ...
              {NAV_ITEMS.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {item.label}
                        <ChevronDown
                          className={`h-4 w-4 text-[#232323] opacity-60 transition-transform duration-300 ${
                      ...
                      <div
                        className={`absolute top-full left-[-12px] pt-[6px] w-[210px] z-50 transition-all duration-300 origin-top-left ${
                ...
                if (item.label === "Ecom Ecosystem") {
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`absolute top-full left-[-12px] pt-[6px] w-[202px] z-50 transition-all duration-300 origin-top-left ${
                ...
                return (
                  ...
                  >
                    ...
                    {item.label}
                    {item.hasDropdown && (
                      <ChevronDown className="h-4 w-4 text-[#232323] opacity-60" />
                    )}
                  </NextLink>
                );
              })}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12 w-full text-left">
          ...
          <div>
            ...
            <ul className="flex flex-col">
              <li>
                <NextLink
                  href={getLocalizedHref("/solutions/cross-border")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
              ...
              <li>
                <NextLink
                  href={getLocalizedHref("/solutions/b2b-shipping")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
              ...
              <li>
                <NextLink
                  href={getLocalizedHref("/solutions/fulfillment")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
                  Fulfillment service
                </NextLink>
          ...
          <div>
            ...
            <ul className="flex flex-col">
              <li>
                <NextLink
                  href={getLocalizedHref("/ecosystem/flash-pod")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
                  Flash POD
                </NextLink>
              ...
              <li>
                <NextLink
                  href={getLocalizedHref("/ecosystem/partners")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
                  Partner
                </NextLink>
          ...
          <div>
            ...
            <ul className="flex flex-col">
              <li>
                <NextLink
                  href={getLocalizedHref("/resources/hs-code")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
                  HS code
                </NextLink>
              ...
              <li>
                <NextLink
                  href={getLocalizedHref("/resources/tariff-simulator")}
                  className="py-2 text-[15px] text-[#7A7A7A] hover:text-[#0F798C] transition-colors block"
                >
                  Tariff simulation
                </NextLink>
